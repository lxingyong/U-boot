...
// lib/asm-offsets.c -mbionic -mstrict-align -march=armv8-a -mlittle-endian
...
.ascii "->GENERATED_GBL_DATA_SIZE 352 (sizeof(struct global_data) + 15) & ~15"	//
// 0 "" 2
	.loc 1 25 0
// 25 "lib/asm-offsets.c" 1
	
.ascii "->GENERATED_BD_INFO_SIZE 240 (sizeof(struct bd_info) + 15) & ~15"	//
// 0 "" 2
	.loc 1 28 0
// 28 "lib/asm-offsets.c" 1
	
.ascii "->GD_SIZE 344 sizeof(struct global_data)"	//
// 0 "" 2
	.loc 1 30 0
